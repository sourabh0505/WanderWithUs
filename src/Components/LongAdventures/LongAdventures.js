...
function LongAdventures() {
  return (
    <div className="LongAdventures" id="long-escape">
      <div className="LongAdventures-heading">
      <h1>LONG ADVENTURES? HOP ON!</h1>
      <hr />
      </div>
